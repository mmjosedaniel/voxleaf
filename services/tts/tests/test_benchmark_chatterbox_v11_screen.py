"""Model-free checks for the decision-neutral Chatterbox RTX 50 v11 screen."""
...
from benchmarks.v11_authority import CANDIDATE_ID, load_frozen_v11_authority
...
def test_isolated_worker_import_does_not_require_service_schema_validator() -> None:
    completed = subprocess.run(
        (
            sys.executable,
            "-c",
            ("import sys;sys.modules['jsonschema']=None;import benchmarks.chatterbox_v11_screen"),
        ),
        cwd=SERVICE_ROOT,
        check=False,
        capture_output=True,
