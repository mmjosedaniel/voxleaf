"""Model-free checks for the decision-neutral Chatterbox CUDA v10 screen."""
...
from benchmarks.v10_authority import CANDIDATE_ID, load_frozen_v10_authority
...
def test_isolated_worker_import_does_not_require_service_schema_validator() -> None:
    completed = subprocess.run(
        (
            sys.executable,
            "-c",
            ("import sys;sys.modules['jsonschema']=None;import benchmarks.chatterbox_v10_screen"),
        ),
        cwd=SERVICE_ROOT,
        check=False,
        capture_output=True,
