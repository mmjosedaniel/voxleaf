"""Decision-neutral bounded Chatterbox RTX 50 compatibility screen."""
...
AUTHORITY_COMMIT_SHA: Final = "915cd039a51d8b85eb9e6a6612b79b0e8b1c0a33"
...
class ChatterboxV11ScreenError(RuntimeError):
    """Fixed content-free screen failure."""

    def __init__(self, code: str) -> None:
        super().__init__(f"tts-chatterbox-v11-screen:{code}")
        self.code = code


def _fail(code: str) -> NoReturn:
    raise ChatterboxV11ScreenError(code)
...
def run_corrective_preflight(
    *,
    ...
    load_frozen_v11_authority(REPOSITORY_ROOT)
...
def _raw_payload(
    *,
    ...
    return {
        "schemaVersion": "tts-bilingual-raw-v11",
