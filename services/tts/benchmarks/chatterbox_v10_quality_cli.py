"""Closed-stdin generation command for Chatterbox CUDA v10 quality evidence."""
...
def _read() -> dict[str, object]:
    ...
    if len(raw.encode("utf-8")) > MAXIMUM_STDIN_BYTES:
        raise ChatterboxV10QualityError("input-limit")
    try:
        value = cast(object, json.loads(raw))
    except json.JSONDecodeError:
        raise ChatterboxV10QualityError("input") from None
    if (
        ...
        raise ChatterboxV10QualityError("input")
