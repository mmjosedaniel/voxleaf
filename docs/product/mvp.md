...
- Implement and execute the frozen Milestone 6.2 v4 evaluation before claiming
  that shared-model batch size two supports sustainable or continuous
  narration.
