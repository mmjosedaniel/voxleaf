...
1. M009.1 passes the required Ubuntu and Windows checks for the locally closed
   visible-highlight repair, fixed compact reader shell, and bounded
   locator-backed paragraph leaf, then archives its ExecPlan.
