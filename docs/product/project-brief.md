...
| Internal audio                    | Complete-unit format selected; playback queue open                    | Bounded 24-kHz mono float32-le service units; one-unit desktop sink exists outside React state                                                                                              | M008 must implement the multi-unit queue/player, memory ceilings, playback quality, and speed control                                                                 |
