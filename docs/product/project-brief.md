...
| Bilingual narration               | Preparation/selection implemented; bilingual profile admissions complete, integration pending | M010.1 admits Piper/joe English, Chatterbox Spanish/English, Qwen/Serena Spanish, and Qwen/Aiden English after exact frozen evidence and maintainer review                                                                   | Integrate and exact-host prove every admitted language/profile combination in Milestone 6; current runtime support remains Piper/davefx Spanish until then            |
