...
| CPU fallback                      | Selected; runtime integration pending                                   | Piper 1.4.2, `es_ES-davefx-medium`, ONNX Runtime CPU float32; total sustained RTF 0.0252, 392 MiB measured peak RAM, overall quality 4.621/5                                                | M010 Milestone 6 must add executable registry/service/settings integration and resilience proof; M011 must fulfill GPL/CC0 packaging obligations                      |
...
| Internal audio                    | Exact-development product path implemented and host-validated           | Bounded mono float32-le units; sole-owner FIFO; one transient active-device copy; Web Audio; content-free controls and metrics                                                              | No audio persistence or standard-profile claim; Piper's 22.05-kHz runtime path remains Milestone 6 work                                                               |
