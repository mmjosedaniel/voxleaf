...
| TTS process                       | Model-free native boundary implemented; exact adapter open | One persistent native-owned child over framed standard streams, narrow typed commands, process-tree termination, and complete-unit binary handoff | Integrate and validate the exact Qwen adapter; product playback, production graduation, and general-hardware support remain blocked                                   |
