...
| Bilingual narration               | Preparation/selection implemented; English baseline admitted, integration pending | M010.1 Milestone 2 provides explicit Spanish/English selection, bounded persistence, `narration-bilingual-v2`, exact profile/language admission, and identity-safe replacement; Milestone 3 admits exact Piper/joe English after all frozen v8 baseline gates pass | Integrate and exact-host prove Piper English in Milestone 6; independently evaluate the remaining exact Qwen and new-engine profiles                                   |
