...
| Blocker-resolution candidate | Frozen for evaluation only | Qwen3-TTS 12Hz 1.7B CustomVoice, Serena, neutral Spanish audiobook instruction, CUDA bfloat16/SDPA | Pass the prototype stop gate plus exact local cancellation, quality, performance, resources, offline, licensing, packaging, and cleanup gates |
