...
| Adaptive demo buffering           | Exact-development path and final policy implemented                   | Quick default; explicit 1-/2-/5-/10-minute preparation with 1 minute initially selected; 1-minute refill; 10-second warning; zero default boundary wait; approximately 30-minute ceiling     | Synchronization remains M009; production/general-hardware graduation remains blocked                                                                                  |
...
| Internal audio                    | Exact-development product path implemented                            | Bounded 24-kHz mono float32-le units; sole-owner FIFO; one transient active-device copy; Web Audio; content-free controls and metrics                                                        | Synchronization remains M009; no audio persistence or standard-profile claim                                                                                           |
