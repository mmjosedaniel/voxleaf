...
published gate. The ordinary Download action is compatibility-gated, and signed
public publication is pending external authorization.
Current
...
using published requirements plus representative evidence. Milestone 6B closed
the ordinary Download and release-isolation work. Describe the current unsigned
