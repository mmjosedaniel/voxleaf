...
| --------------------------------- | ------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Desktop                           | Implemented; release claims NO-GO                                                | Tauri 2, React, TypeScript, and Vite; M011 adds the unsigned local Windows x64 package and Milestone 6A lifecycle feedback plus bounded uninstall choices                                                                                | The exact final Piper hash still needs the formal corrected clean-host/manual lifecycle; optional support and trusted public signing remain unavailable                                                           |
...
| CPU fallback                      | Supported runtime; release portfolio NO-GO                                      | Piper 1.4.2, davefx/Spanish and joe/English, ONNX Runtime CPU float32; davefx total sustained RTF 0.0252 and about 392 MiB measured peak model-tree RAM                                                                                  | M011's packaged core includes GPL/phonemizer source mechanics, model cards, provenance, and CC0 notices; the exact candidate lacks formal corrected clean-host release evidence                                   |
...
| Bilingual narration               | Runtime integration complete; distributable claims NO-GO                        | Piper davefx/Spanish and joe/English are supported CPU paths; Chatterbox Spanish/English is supported on its exact development host; Qwen Serena/Spanish and Aiden/English are development-only                                           | M011 intends Piper for the core and keeps Chatterbox withheld until its compatible clean-GPU-host lifecycle passes; runtime support does not imply download availability                                           |
...
verified runtime delivery for a minimal removable Chatterbox option. Milestone
7 nevertheless records NO-GO for Piper portfolio readiness, downloadable
Chatterbox, and signed public publication because their clean-host, clean-GPU-
host, and trusted-signing evidence remains unavailable.
Current
...
Milestone 7 confirms that M011 has not closed the clean-host lifecycle and
applicable signing gates. Describe release availability prospectively even
though the local reader, narration paths, exact shipped payload, licences, and
dependency/integrity audits are implemented:
