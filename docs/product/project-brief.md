...
[`narration-piper-v1`](../architecture/piper-narration-preparation-profile-v1.md)
size limits over that unchanged normalization. It creates more, shorter,
