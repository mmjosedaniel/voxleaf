...
| CPU fallback                      | Integrated; packaged resilience arm passed                              | Piper 1.4.2, `es_ES-davefx-medium`, ONNX Runtime CPU float32; total sustained RTF 0.0252, 392 MiB measured peak model-tree RAM, overall quality 4.621/5; packaged quick start 3.066 s with zero underruns | M010 still needs the final Qwen offline arm and Milestone 7 closeout; M011 must fulfill GPL/CC0 packaging obligations                                                    |
