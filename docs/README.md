...
- [`architecture/decisions/ADR-0018-reader-experience-stabilization.md`](architecture/decisions/ADR-0018-reader-experience-stabilization.md): accepted result-blind M009.1 reader-experience authority; highlight materialization and the fixed compact reader shell are implemented while the bounded leaf remains planned.
...
- [`plans/active/M009-001-reader-experience-stabilization.md`](plans/active/M009-001-reader-experience-stabilization.md): active bounded M009 follow-up for the visible-highlight discrepancy, dedicated reader viewport, compact/collapsible narration UI, text-only loaded-duration status, and locator-backed paragraph leaf. Milestones 1-2 are complete; Milestone 3's fixed shell is implemented with clean-host packaged validation pending; Milestones 4-6 remain.
