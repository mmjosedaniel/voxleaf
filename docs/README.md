...
- [`plans/active/M009-001-reader-experience-stabilization.md`](plans/active/M009-001-reader-experience-stabilization.md): active bounded M009 follow-up for the visible-highlight discrepancy, dedicated reader viewport, compact/collapsible narration UI, text-only loaded-duration status, and locator-backed paragraph leaf. Milestones 1-5 are implemented; the corrected private-EPUB interaction and amended exact-host matrix pass, and Milestone 6 repository/clean-host/pull-request closeout remains.
