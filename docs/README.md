...
- [`plans/active/M009-001-reader-experience-stabilization.md`](plans/active/M009-001-reader-experience-stabilization.md): approved bounded M009 follow-up for the visible-highlight discrepancy, dedicated reader viewport, compact/collapsible narration UI, text-only loaded-duration status, and locator-backed paragraph leaf. Implementation has not started.
