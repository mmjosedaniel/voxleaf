...
- [`plans/active/M005-narration-text-preparation.md`](plans/active/M005-narration-text-preparation.md): active implementation authority for roadmap Milestone 5's deterministic, bounded, locator-linked narration normalization and semantic segmentation pipeline; Task 2.1's package-internal exhaustive source projector is implemented while source spans, normalization, segmentation, bounds, lifecycle integration, and the public operation remain pending.
