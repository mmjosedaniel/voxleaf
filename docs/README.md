...
- [`plans/active/M006-002-qwen-short-segment-batch-feasibility.md`](plans/active/M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 evaluation. Its completed `v4` arms stopped safely and `selection-v4` selects neither placement. Milestone 6 freezes the separate independent GPU-primary/CPU-support `v5` authority; pending Milestones 7-10 own implementation, hardware evidence, bounded playback/quality review, and the final decision.
