...
- [`plans/active/M006-002-qwen-short-segment-batch-feasibility.md`](plans/active/M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 evaluation. Milestone 1 froze the v4 authority and deterministic enforcement; the runner and hardware execution remain later milestones.
