...
- [`plans/active/M006-001-local-tts-profile-blocker-resolution.md`](plans/active/M006-001-local-tts-profile-blocker-resolution.md): active Milestone 6.1 blocker-resolution plan; Milestones 1–4 froze Serena, proved the bounded prototype, extended the benchmark, and completed the failed official `v3` evaluation. Constrained demo selection and repository closeout remain.
