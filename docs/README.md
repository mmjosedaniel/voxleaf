...
- [`plans/active/M006-002-qwen-short-segment-batch-feasibility.md`](plans/active/M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 evaluation. Its completed `v4` full-GPU and targeted-CPU arms stopped safely before throughput or quality evidence. Pending Milestones 6-10 preserve that failure while freezing and testing a separate independent GPU-primary/CPU-support `v5` topology with 8-16-second target units and a five-minute bounded maximum.
