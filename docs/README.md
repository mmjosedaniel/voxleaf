...
- [`plans/active/M006-002-qwen-short-segment-batch-feasibility.md`](plans/active/M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 evaluation. Milestones 3 and 4 completed the full-GPU and targeted-CPU arms; both stopped safely on the frozen shared-memory rule before throughput or quality evidence, so Milestone 5 is not admitted.
