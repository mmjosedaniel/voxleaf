...
- [`plans/active/M006-002-qwen-short-segment-batch-feasibility.md`](plans/active/M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 evaluation. Milestone 3's full-GPU arm stopped safely on the frozen shared-memory rule, admitting the separate targeted-CPU Milestone 4 arm without producing throughput or quality evidence.
