...
- [`plans/active/M005-narration-text-preparation.md`](plans/active/M005-narration-text-preparation.md): active implementation authority for roadmap Milestone 5's deterministic, bounded, locator-linked narration normalization and semantic segmentation pipeline; Tasks 2.1-2.2 implement package-internal exhaustive source projection and code-point source-span tokens while normalization, segmentation, bounds, lifecycle integration, and the public operation remain pending.
