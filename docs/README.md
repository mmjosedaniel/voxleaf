...
- [`plans/active/M006-002-qwen-short-segment-batch-feasibility.md`](plans/active/M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 evaluation. Its completed `v4` arms stopped safely and `selection-v4` selects neither placement. Milestone 8 records a passing `v5` CPU admission, slower-than-real-time GPU baseline, and concurrent `resource-limit` stop; Milestone 9 is not admitted and Milestone 10 must record the final decision.
