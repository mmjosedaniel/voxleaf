...
- the public bounded preparation operation and broader synthetic integration matrix exist, while Task 5.3 still owns the deterministic exact-bound proof;
