...
- the public bounded preparation operation exists, while Tasks 5.2-5.3 still own the broader synthetic integration matrix and deterministic exact-bound proof;
