...
- The visual reader owns displayed text and the active logical locator. Tasks 2.1-2.2 now implement package-internal exhaustive narration source projection and Unicode-code-point source-span tokens; normalization, segmentation, public preparation, TTS, audio, highlighting, and reader/audio synchronization are not implemented.
