...
This broad plan predates the milestone-specific implementation plans and intentionally spans visual reading, narration synchronization, and audio startup work. The completed [`M004-reflowable-visual-reader-and-position-restoration.md`](../completed/M004-reflowable-visual-reader-and-position-restoration.md), [`M005-narration-text-preparation.md`](../completed/M005-narration-text-preparation.md), [`M006-local-tts-feasibility-and-engine-profiles.md`](../completed/M006-local-tts-feasibility-and-engine-profiles.md), [`M006-001-local-tts-profile-blocker-resolution.md`](../completed/M006-001-local-tts-profile-blocker-resolution.md), [`M006-002-qwen-short-segment-batch-feasibility.md`](../completed/M006-002-qwen-short-segment-batch-feasibility.md), [`M007-local-tts-service-and-process-protocol.md`](../completed/M007-local-tts-service-and-process-protocol.md), [`M008-bounded-adaptive-prebuffering.md`](../completed/M008-bounded-adaptive-prebuffering.md), [`M009-synchronized-reading-and-narration.md`](../completed/M009-synchronized-reading-and-narration.md), and [`M009-001-reader-experience-stabilization.md`](../completed/M009-001-reader-experience-stabilization.md) plans record the implementation authority and evidence for roadmap Milestones 4 through 9. Completed M009 supersedes this document for synchronization implementation, and completed M009.1 amends its passive-navigation behavior so ordinary scrolling does not replace narration. Retain this document only as broad historical context.
...
Roadmap Milestones 1 through 10, M008.1, and M009.1 are complete. The repository now has a reproducible cross-language workspace and CI, canonical shared schemas and runtime decoders, deterministic test fakes, a React/Tauri desktop application, an implemented framework-independent `@voxleaf/epub` boundary for bounded in-memory ingestion, immutable semantic documents, lazy raster reads, deterministic locator creation/resolution, and bounded locator-linked narration preparation. The completed TTS feasibility work selects no viable standard GPU profile while completed M010 supports exact Piper/davefx and retains the exact Qwen/Serena constrained development demo. M010.1 bilingual/candidate work is approved planned, not implemented.

The desktop implements capability-free local EPUB selection, publication lifecycle, safe semantic text/static-image rendering, TOC/internal/chapter navigation, continuous reflowable layout and closed preferences, keyboard/focus behavior, bounded large-chapter rendering, semantic code-point/DOM mapping, passive visual-locator tracking, reflow preservation, bounded Web Storage persistence, and exact/nearest-valid restoration after exact-file reselection. Completed M007 implements and validates the constrained development-only Qwen/Serena engine, versioned process protocol, native supervisor, and typed one-unit handoff. Completed M008 calls `OpenedPublication.prepareNarration` from the active visual locator and connects one-at-a-time synthesis to a bounded multi-unit FIFO, Web Audio player, and quick/prepared controls. Completed M009 adds bounded audible source-range projection, segment highlighting, focus-safe following, identity-first synchronized seek, non-skipping heard-position persistence, exact-host synchronization evidence, and repository/CI closeout. Completed M010 implements privacy-safe native host detection, measured profile matching, bounded preference reuse, compatibility UI, pre-start enforcement, identity-safe explicit recovery, the supported Piper/davefx CPU fallback, and the final support matrix. Replacement closeout CI passes; M010.1 bilingual/candidate work is approved planned, and M011 distribution remains.
...
- Actual result at this historical checkpoint: the desktop visual-position owner, semantic range mapper, bounded storage adapter, lifecycle save coordinator, and exact/nearest-valid restoration flow were implemented and validated. Later M008-M009 work subsequently added narration start, narration-segment projection, speech highlighting, and focus-safe playback following.
...
The implementation toolchain, shared contracts, secure EPUB package, visual reader, bounded position persistence/restoration, and Milestone 5 narration-preparation boundary now exist. Completed M007 provides the bounded protocol, native supervision, typed client, exact development-only Qwen/Serena adapter, and frozen exact-host service-handoff evidence. Completed M008 provides the constrained product narration caller, bounded in-memory FIFO, Web Audio playback, quick/prepared controls, and measured exact-host demo evidence. Completed M009 adds bounded audible projection, reader highlight/follow behavior, identity-first synchronized user navigation, non-skipping heard-position persistence, passing exact-host proof, and final repository/CI validation. M010 adds privacy-safe exact Windows host matching, supported Piper/davefx fallback, and explicit identity-safe recovery while retaining no supported standard GPU profile. Cross-platform/general-population support and production distribution remain unimplemented. Retain this broad plan as historical context; use the focused completed/active ExecPlans as current evidence and do not use this plan to claim that planned systems work.
