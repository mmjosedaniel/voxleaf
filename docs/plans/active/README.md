...
- [`M006-002-qwen-short-segment-batch-feasibility.md`](M006-002-qwen-short-segment-batch-feasibility.md): active Milestone 6.2 plan. `selection-v4` selects neither stopped placement, and Milestone 6 freezes the separate `v5` GPU-primary/CPU-support authority with model-free enforcement. Pending Milestones 7-10 must implement and run the independent dual-worker benchmark, evaluate the 8-16-second-unit/five-minute-bounded playback hypothesis, and close the resulting decision.
