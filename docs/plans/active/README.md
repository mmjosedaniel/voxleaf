...
- [`M007-local-tts-service-and-process-protocol.md`](M007-local-tts-service-and-process-protocol.md): active plan for the constrained one-GPU local service, versioned process protocol, native supervision, complete-unit audio delivery, cancellation containment, and exact-host validation. Milestones 1-3 are complete with model-free native and packaged evidence; exact Qwen integration remains open. Production and general-hardware support remain blocked.
