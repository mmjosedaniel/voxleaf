...
- [`M006-001-local-tts-profile-blocker-resolution.md`](M006-001-local-tts-profile-blocker-resolution.md): active Milestone 6.1 closeout plan. The exact Qwen3-TTS 1.7B CustomVoice/Serena batch-one `v3` matrix failed standard performance, reliability, and mid-generation cancellation gates; ADR-0014 permits only a constrained development demo. Final selection/repository closeout remains.
