...
- Preserve ADR-0009's capability-free file ingress and ADR-0010's bounded static-raster decode/object-URL policy, use Task 1.5's established real-browser tooling, and resolve measured large-chapter limits before claiming the complete reader boundary works.
