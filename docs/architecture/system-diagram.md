...
1. **Milestone 6.2 — Planned:** freeze and execute the separate short-unit/shared-model batch evaluation. Run targeted CPU placement only if the full-GPU arm reaches its predeclared memory stop condition.
