...
| Bilingual narration and candidate screening        | **In progress**                                 | M010.1 Milestone 1 freezes explicit Spanish/English product behavior, additive locator-safe normalization, exact candidate identities and locks, synthetic corpora, schemas, result-blind gates, and stop conditions. CosyVoice is rejected from v7 intake because no exact non-personal default voice path was frozen. No English runtime support or additional product engine is implemented yet.                                                                                                                                                                                                                                                                                                 |
...
flowchart LR
    ...
    subgraph DEVICE["User device / local-only trust boundary"]
        ...
        subgraph TTSAREA["services/tts and later local runtime"]
            ...
            BILINGUAL["English baseline + bounded candidate screen<br/>M10.1 authority frozen;<br/>runtime not implemented"]:::progress
        end
    end
...
corpus, schema, and evaluation authority, but still represents unimplemented
runtime data flow. It may become solid only after the corresponding
implementation and exact-profile evidence pass; the existing M010 matrix
remains authoritative meanwhile.
...
| Bilingual narration and candidate screening             | [M010.1 active ExecPlan](../plans/active/M010-001-bilingual-narration-and-candidate-screening.md), frozen [bilingual product authority v1](bilingual-narration-authority-v1.md), [normalization v2](narration-normalization-v2.md), [v7 evaluation profile](tts-feasibility-profile-v7.md), and [ADR-0024](decisions/ADR-0024-freeze-bilingual-v7-authority.md). Milestone 1 is authority-only: current narration remains Spanish-only and M010's support matrix remains authoritative until later implementation and exact evidence pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
5. **Milestone 10.1 — In progress:** Milestone 1 freezes explicit
   Spanish/English product and v7 evaluation authority; later milestones must
   implement and evaluate it without claiming support before evidence passes.
