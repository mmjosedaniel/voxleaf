...
| Local TTS profiles and release distribution        | **Local profiles and verified Piper payload implemented** | M010.1 implements supported Chatterbox Spanish/English plus language-matched Piper CPU profiles; Qwen Serena/Aiden remain development-only. M011 Milestone 3 now builds a private embedded Piper Spanish-English core with complete notices/source and native manifest verification. The installer and separately gated optional Chatterbox GPU download remain planned; Qwen remains outside the first distributable product.                                                          |
...
| Release packaging                                  | **Milestones 1-3 complete; core payload implemented**     | M011 release authority v1 freezes the Windows x64/private embedded Piper core and separate optional Chatterbox boundary. Milestones 2-3 close the production locks, audits, 367-component inventory, deterministic bilingual Piper payload, compliance bundle, measurements, and native verification. Installer integration, optional acquisition, signing, and complete-MVP release evidence remain planned.                                                                           |
...
flowchart LR
    ...
    RELEASE_GRAPH["Release locks + audit + inventory<br/>M11 M2-M3 implemented;<br/>367 components + explicit blind spots"]:::implemented
    ...
    ARTIFACT_SOURCE -.->|"explicit allowlisted HTTPS download"| ACQUISITION
...
separate 79-package lock, and one release audit/inventory boundary records 367
...
| MVP packaging and release                               | [Active M011 ExecPlan](../plans/active/M011-package-validate-and-release-mvp.md), frozen [release authority v1](mvp-release-authority-v1.md), accepted [ADR-0042](decisions/ADR-0042-freeze-mvp-release-authority.md), [release security/distribution boundary](../development/release-security-and-distribution.md), exact [component inventory](../../services/tts/release/component-inventory-v1.json), and [Piper package evidence](../../services/tts/release/core/core-package-evidence-v1.json). Milestones 1-3 freeze the topology, close the dependency/audit boundary, and implement the verified bilingual Piper payload with compliance fulfillment. Installer integration, optional acquisition, signing, and complete release evidence remain future milestones.                                                                                                                                                                                                                                                                                                                                                                                                    |
...
7. **Milestone 11 — In progress:** Milestone 1 freezes the exact minimum
   ...
   notices/source evidence. Milestone 4 is next: optional acquisition, then normal-user
