...
- Milestone 4: persistence technology, save lifecycle/migration, real-browser tooling, and measured large-chapter/reader performance limits. ADR-0008 resolved the visual-reader boundaries, ADR-0009 resolved local file ingress without native permissions, and ADR-0010 resolved bounded static-raster decode/CSP/lifetime behavior.
