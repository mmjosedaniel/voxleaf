...
| Bilingual narration and candidate screening        | **In progress; preparation/selection implemented** | M010.1 Milestone 2 implements `narration-bilingual-v2`, the bounded Spanish/English preference, accessible explicit selection, exact profile/language admission, and identity-safe cancellation/cleanup. Milestones 1/1A retain superseding result-blind v8 authority for exact Qwen Serena/Spanish and Aiden/English plus the Piper English, Chatterbox, and MOSS evaluations. No English engine or additional supported profile is admitted yet.                                                                                                                                                                                                                                                                                                      |
