...
| Standard production TTS profile and distribution   | **Blocked; CPU fallback integrated**     | ADR-0013 still selects no passing standard profile. Piper/davefx passes the separate v6 CPU-fallback gate and now has executable runtime/settings integration through M010 Milestone 6; production distribution remains M011 work.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| Boundary-aware audio transitions                   | **In progress; local validation passes** | M008.1 reduces the completed prepared segment's semantic boundary to one bounded numeric delay and schedules at most one interruptible timer before an already-buffered successor. Hard/token splits remain continuous; real buffering replaces the delay; no silent PCM, model-input change, protocol field, or persistent data is added. Deterministic, portable, and authoritative Windows repository validation pass; required pull-request closeout remains.                                                                                                                                                                                                                          |
...
| Hardware profiles, fallback, and resilience        | **In progress; Milestones 1-6 complete** | M010 Milestones 1-6 implement detection, matching, preference/recheck UI, identity-safe recovery, the passing Piper/davefx CPU-fallback decision, fourth executable Piper profile, exact isolated service adapter, profile-aware supervision/settings, Piper-only locator-safe spoken-expansion-aware preparation, nonspoken-unit omission, valid zero-sentence-boundary fragment scheduling, native configuration admission, and the resilience runner. Corrective ordinary-prose, compact-form, configured-runtime, and content-safe packaged private-book playback pass. ADR-0022 retains Qwen's generic total-VRAM gate and adds a narrow development-only available-VRAM reserve; packaged selection and inference now run, while its later depletion assertion remains failed. Milestone 7 remains. |
...
| Boundary-aware generated-unit transitions               | [M008.1 active ExecPlan](../plans/active/M008-001-boundary-aware-audio-transitions.md), frozen [playback transition policy v1](playback-transition-pause-policy-v1.md), and accepted [ADR-0021](decisions/ADR-0021-boundary-aware-audio-transitions.md). Deterministic, portable, authoritative Windows, privacy/repository, and relative-link validation pass; required pull-request checks remain.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| Hardware profiles, fallback, and operational resilience | [M010 active ExecPlan](../plans/active/M010-hardware-profiles-fallback-and-operational-resilience.md), frozen [hardware/profile/recovery authority v1](hardware-profile-recovery-authority-v1.md), accepted [ADR-0019](decisions/ADR-0019-privacy-safe-hardware-profiles-and-recovery.md), corrective [Qwen development VRAM authority v1](qwen-development-vram-admission-v1.md) and [ADR-0022](decisions/ADR-0022-qwen-development-vram-admission.md), passing [Piper v6 result](../../benchmarks/tts/cpu-fallback-result-v6.json), accepted [selection-v6](../../benchmarks/tts/selection-v6.md), [ADR-0020](decisions/ADR-0020-admit-piper-cpu-fallback.md), historical [Piper narration preparation profile v1](piper-narration-preparation-profile-v1.md), implemented [Piper narration preparation profile v2](piper-narration-preparation-profile-v2.md), and frozen [runtime-configuration availability v1](tts-profile-runtime-configuration-availability-v1.md). Milestones 1-6 are complete; Milestone 6 implements CPU fallback integration, Piper-only locator-safe spoken-expansion-aware preparation, nonspoken-unit omission, valid zero-sentence-boundary fragment scheduling, native configuration admission, the passing corrective Piper matrix, content-safe packaged private-book confirmation, and corrected development-only Qwen admission with its later depletion limitation retained. |
...
3. **Milestone 8.1 — In progress:** the frozen semantic transition policy and
   deterministic desktop implementation pass focused, portable, authoritative
   Windows, privacy/repository, and relative-link validation. Required
   pull-request checks remain.
4. **Milestone 10 — In progress:** Milestones 1-6 are complete. Milestone 6 implements and exact-host validates the passing Piper CPU-fallback integration, Piper-only locator-safe spoken-expansion-aware preparation, nonspoken-unit omission, valid zero-sentence-boundary fragment scheduling, native exact-runtime configuration admission, profile-specific resilience matrix, and content-safe packaged private-book confirmation. Qwen passes offline service validation and corrected development-only VRAM admission, executes packaged inference, and retains its later failed depletion assertion. Milestone 7 owns final support decisions and closeout.
5. **Milestone 11 — Deferred:** complete installer/signing/distribution and full MVP closeout only after M010 establishes supportable hardware and recovery claims.
