...
| Bilingual narration and candidate screening        | **In progress; English baseline admitted, integration pending** | M010.1 Milestone 2 implements `narration-bilingual-v2`, the bounded Spanish/English preference, accessible explicit selection, exact profile/language admission, and identity-safe cancellation/cleanup. Milestone 3 independently admits exact Piper/joe English after every frozen v8 baseline gate passes. The current executable registry remains unchanged, so English is not selectable or supported until Milestone 6 integrates and proves it. Exact Qwen Serena/Spanish and Aiden/English plus Chatterbox and MOSS evaluations remain pending.                                                                                                                                                                                                                    |
...
flowchart LR
    ...
    subgraph DEVICE["User device / local-only trust boundary"]
        ...
        subgraph TTSAREA["services/tts and later local runtime"]
            ...
            BILINGUAL["Bilingual preparation + explicit selection<br/>M10.1 Milestone 2 implemented;<br/>English engine evaluation pending"]:::progress
        end
    end
...
profile/language pair is rejected before child start. The remaining dashed
candidate portion represents unexecuted exact-profile evidence; no English
engine is selectable and the existing M010 matrix remains authoritative.
...
| Bilingual narration and candidate screening             | [M010.1 active ExecPlan](../plans/active/M010-001-bilingual-narration-and-candidate-screening.md), implemented [bilingual product authority v1](bilingual-narration-authority-v1.md) and [normalization v2](narration-normalization-v2.md), historical resultless [v7 evaluation profile](tts-feasibility-profile-v7.md), superseding [v8 evaluation profile](tts-feasibility-profile-v8.md), exact content-safe [Piper English v8 result](../../benchmarks/tts/piper-english-result-v8.json), [ADR-0024](decisions/ADR-0024-freeze-bilingual-v7-authority.md), and [ADR-0025](decisions/ADR-0025-supersede-v7-with-local-qwen-bilingual-v8-authority.md). Milestone 2 implements model-free preparation and selection; Milestone 3 admits Piper/joe English for later integration. M010's current runtime support matrix remains authoritative until Milestone 6 integrates and proves the new profile.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
