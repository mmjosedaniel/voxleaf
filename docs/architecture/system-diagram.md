...
| EPUB 2/NCX compatibility                           | **In progress**                                                                             | ADR-0048 and active Milestone 3.1 authorize one bounded OPF 2.0/NCX path through the same internal semantic/navigation model. Milestones 1-3 implement fixture authority, exact OPF 2 admission, inert NCX/XHTML 1.1 doctypes, bounded NCX parsing, shared target resolution, and package-level public opening. Reader/restoration/narration equivalence and full-plan validation remain open, so no completed EPUB 2 support claim exists yet; M011 Milestone 7 waits for that result.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| Secure EPUB ingestion and locator model                 | [Milestone 3 completed plan](../plans/completed/M003-secure-epub-ingestion-and-document-model.md), [ADR-0007](decisions/ADR-0007-secure-epub-ingestion-boundary.md), and [ADR-0003](decisions/ADR-0003-stable-reading-locators.md) are the completed EPUB 3 authority. Accepted [ADR-0048](decisions/ADR-0048-admit-bounded-epub2-and-ncx-compatibility.md) and the [active Milestone 3.1 plan](../plans/active/M003-001-bounded-epub2-and-ncx-compatibility.md) authorize the additive OPF 2.0/NCX profile; its Milestones 1-3 implement the package/navigation boundary while downstream equivalence and full validation remain open.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
6. **Milestone 10.2 — Complete:** v1 authority and
   ...
   pass.
7. **Milestone 3.1 — In progress:** ADR-0048 and the active ExecPlan
   authorize a bounded OPF 2.0/NCX path through the existing semantic,
   locator, reader, restoration, and narration owners. Milestones 1-3
   implement and focus-test package admission, inert doctypes, NCX parsing,
   shared target resolution, and package-level opening. Milestones 4-5 still
   own downstream equivalence and full acceptance; the support claim remains
   EPUB 3-only until those gates pass.
