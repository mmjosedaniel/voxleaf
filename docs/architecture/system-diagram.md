...
flowchart LR
    ...
    PACKAGE["Windows x64 per-user NSIS installer<br/>M11 M5: VoxLeaf 0.1.0 + Piper ES/EN;<br/>local lifecycle passed, clean-host pending"]:::progress
