...
8. **Milestone 11 — Renewed Milestone 7 local closeout complete; required pull-request checks pending:** Milestone 1 freezes the exact minimum
   ...
   and journey and records the independent local/portfolio decisions. Required
   pull-request checks remain before archival. Trusted public signing remains
   externally pending.
