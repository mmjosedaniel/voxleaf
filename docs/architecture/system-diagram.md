...
| Hardware profiles, fallback, and resilience        | **Next approved active plan**           | M010 is unblocked after completed M009.1. No general hardware inventory, measured product profile, validated CPU fallback, automatic recovery policy, production dependency, or support claim exists yet.                                                                                                                                                                                                                     |
