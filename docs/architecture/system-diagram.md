...
flowchart LR
    ...
    subgraph DEVICE["User device / local-only trust boundary"]
        ...
        subgraph TTSAREA["services/tts and later local runtime"]
            ...
            CHATTERBOX_PACKAGE["Optional Chatterbox GPU profile<br/>official model + immutable split runtime;<br/>corrected cb/2 tree + removable cb/cache;<br/>withheld pending lifecycle"]:::progress
