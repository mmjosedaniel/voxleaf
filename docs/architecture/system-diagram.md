  ...
  subgraph device["User device — local-first boundary"]
    ...
    subgraph libraries["Framework-independent TypeScript packages"]
      ...
      subgraph epubPackage["@voxleaf/epub"]
        ...
        narration["Narration source projection, deterministic normalization,<br/>semantic segmentation and bounded prepared segments<br/>[In progress: Tasks 2.1-2.3 source/lifecycle implemented]"]:::inprogress
        epubCore -->|Tasks 2.1-2.3 bounded locator-aware source work| narration
      end
