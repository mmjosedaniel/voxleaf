...
| Standard production TTS profile and distribution   | **Blocked; CPU fallback selected**      | ADR-0013 still selects no passing standard profile. Piper/davefx passes the separate v6 CPU-fallback gate, but its executable runtime/settings integration remains M010 Milestone 6 and distribution remains M011 work.                                                                                                                                                                                                                                                                 |
