...
| Reader settings and playback controls              | **In progress; authority frozen**                               | M010.2 Milestone 1 freezes the reader-first shell, Settings semantics, English fallback migration, bounded narration preferences, exact playback-rate arithmetic, and closed pitch-preserving backend comparison before implementation. Current runtime remains the completed M010.1 interface, Spanish fallback, and `1.0x`.                                                                                                                     |
...
flowchart LR
    ...
    subgraph DEVICE["User device / local-only trust boundary"]
        subgraph DESKTOP["apps/desktop"]
            ...
            SETTINGS_SPEED["Reader-first Settings + pitch-preserving playback<br/>M10.2 M1 authority frozen;<br/>runtime not implemented"]:::planned
        end
...
The dashed M010.2 node is not a current runtime relationship. Milestone 1 has
frozen its lifecycle-neutral Settings, bounded preferences, English fallback
...
results. Later milestones may compose the existing reader, store,
compatibility, and playback nodes only within that authority.
...
| Reader settings and playback controls                   | [M010.2 active ExecPlan](../plans/active/M010-002-reader-settings-and-playback-controls.md), approved [product requirements](../product/reader-settings-and-playback-controls.md), frozen [authority v1](reader-settings-playback-authority-v1.md), and accepted [ADR-0033](decisions/ADR-0033-freeze-reader-settings-and-pitch-preserving-playback-authority.md). Milestone 1 is complete; no current app-shell, default-language, preference, time-stretch, effective-lead, or playback-rate runtime implementation claim exists. |
