...
| Bilingual narration and candidate screening        | **In progress**                                 | M010.1 Milestones 1/1A freeze explicit Spanish/English product behavior and superseding result-blind v8 authority. V8 preserves resultless v7, adds exact local Qwen/Serena Spanish and Qwen/Aiden English controls, and retains the Piper English plus Chatterbox/MOSS candidates, corpora, locks, gates, and stop rules. CosyVoice, cloud inference, voice cloning, and voice design are excluded. No English runtime support or additional product profile is implemented yet.                                                                                                                                                                                                                                                                                                 |
...
flowchart LR
    ...
    subgraph DEVICE["User device / local-only trust boundary"]
        ...
        subgraph TTSAREA["services/tts and later local runtime"]
            ...
            BILINGUAL["English baseline + local Qwen controls<br/>+ bounded candidate screen<br/>M10.1 v8 authority frozen;<br/>runtime not implemented"]:::progress
        end
    end
...
The dashed M010.1 node now has frozen product, normalization, candidate,
corpus, schema, and superseding v8 evaluation authority, including exact local
Qwen Serena/Spanish and Aiden/English controls, but still represents
unimplemented runtime data flow. It may become solid only after the
corresponding implementation and exact-profile evidence pass; the existing
M010 matrix remains authoritative meanwhile.
...
| Bilingual narration and candidate screening             | [M010.1 active ExecPlan](../plans/active/M010-001-bilingual-narration-and-candidate-screening.md), frozen [bilingual product authority v1](bilingual-narration-authority-v1.md), [normalization v2](narration-normalization-v2.md), historical resultless [v7 evaluation profile](tts-feasibility-profile-v7.md), superseding [v8 evaluation profile](tts-feasibility-profile-v8.md), [ADR-0024](decisions/ADR-0024-freeze-bilingual-v7-authority.md), and [ADR-0025](decisions/ADR-0025-supersede-v7-with-local-qwen-bilingual-v8-authority.md). Milestones 1/1A are authority-only: current narration remains Spanish-only and M010's support matrix remains authoritative until later implementation and exact evidence pass.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
5. **Milestone 10.1 — In progress:** Milestone 1 froze historical v7 and
   Milestone 1A preserved it while freezing superseding v8 with local
   Qwen/Serena Spanish and Qwen/Aiden English controls. Later milestones must
   implement and evaluate the authority without claiming support before
   evidence passes.
