...
| Reader experience stabilization                       | [M009.1 active ExecPlan](../plans/active/M009-001-reader-experience-stabilization.md). The plan reconciles the user-observed highlight discrepancy and freezes the reader viewport, compact/collapsible narration, text-only loaded-duration, and locator-backed leaf work before implementation; it is planning authority, not implementation evidence.                                                                                                      |
...
2. **Milestone 9.1 — Approved planned:** follow the [M009.1 ExecPlan](../plans/active/M009-001-reader-experience-stabilization.md) to reconcile visible highlighting and stabilize the reader-first shell without changing completed synchronization, protocol, segmentation, or buffer authority.
