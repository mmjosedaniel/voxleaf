...
1. **Milestone 7 — Constrained demo planned; production blocked:** implement at most one bounded GPU Qwen development-demo vertical slice under ADR-0015. Do not claim passing performance, continuous playback, native streaming, general hardware support, or production transport.
