...
The final sentence above describes the product data flow: locally closed M007
service and exact-host handoff evidence now exists, but no desktop publication
