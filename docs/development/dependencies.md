...
| ------------------ | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@tauri-apps/api`  | `2.11.1`          | Supplies the typed frontend `invoke` boundary used by M007's narrow model-free binary-response transport probe. It exposes no shell/process plugin and adds no network listener or capability.                                                                                                                                                                                                         | Enabling the global Tauri object or calling undocumented internals would create a broader, less typed frontend surface. ADR-0016 proposes the optimized binary response path.                                                                                                                                                                                                                                                                   |
...
library. ADR-0016 remains proposed until packaged WebView evidence passes. The
