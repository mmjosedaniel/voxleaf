...
- `services/tts/tests/test_qwen_adapter.py` remains model-free while
  ...
  and generation arguments, complete-waveform format/finiteness/size failures,
  content-free engine failures, and cleanup. Importing the adapter does not
  import Qwen or Torch.
