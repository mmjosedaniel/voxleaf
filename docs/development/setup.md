...
requirement or implemented runtime. M007 Milestones 1-6 implement and locally
validate the constrained service boundary. Required final pull-request CI and
plan archival remain before M008 connects product narration and playback.
