...
LangString olderOrUnknownVersionInstalled ${LANG_SPANISH} "Una versión $R4 de ${PRODUCTNAME} está instalada en su sistema. Es recomendable que desinstale la versión actual antes de continuar. Seleccione la operación que desee realizar y pulse Siguiente para continuar."
LangString silentDowngrades ${LANG_SPANISH} "Disminuir la versión está deshabilitado para este instalador. No se puede continuar con el instalador de interfaz gráfica.$\n"
...
LangString webview2InstallError ${LANG_SPANISH} "La instalación de WebView2 falló con el código $1."
LangString webview2InstallSuccess ${LANG_SPANISH} "WebView2 se instaló con éxito"
LangString deleteAppData ${LANG_SPANISH} "Quitar preferencias, posiciones de lectura y estado de recuperación de VoxLeaf (se conservan de forma predeterminada)"
